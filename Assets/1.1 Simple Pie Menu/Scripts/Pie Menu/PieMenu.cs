...
namespace SimplePieMenu
{
    ...
    public class PieMenu : MonoBehaviour
    {
        ...
        private void InitializePieMenu()
        {
            ...
            {
                PieMenuInfo.SetActiveState(false);              
                PieMenuElements.Background.gameObject.SetActive(false);
                PieMenuElements.MenuItemsDir.gameObject.SetActive(false);
                PieMenuElements.Header.gameObject.SetActive(false);
                PieMenuInfo.SetTransitionState(false);
            }
        }
