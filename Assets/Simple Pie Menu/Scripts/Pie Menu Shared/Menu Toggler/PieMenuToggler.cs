...
namespace SimplePieMenu
{
    public class PieMenuToggler : MonoBehaviour
    {
        ...
        private void ShowPieMenu(PieMenuState state)
        {
            ...
            state.PieMenuGO_MenuItem.SetActive(true);
            state.PieMenuGO_Header.SetActive(true);
    ...
    class PieMenuState
    {
        ...
        public GameObject PieMenuGO_MenuItem { get; private set; }
        public GameObject PieMenuGO_Header { get; private set; }
        ...
        public void SetComponents(PieMenu pieMenu)
        {
            ...
            PieMenuGO = PieMenuElements.Background.gameObject;
            PieMenuGO_MenuItem = PieMenuElements.MenuItemsDir.gameObject;
            PieMenuGO_Header = PieMenuElements.Header.gameObject;
